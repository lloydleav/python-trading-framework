...
class Portfolio():
    ...
    @property
    def td_client(self) -> TdAmeritradeClient:
        """Gets the TdAmeritradeClient object for the Portfolio

        Returns:
        ----
        {TdAmeritradeClient} -- An authenticated session with the TD API.
        """

        return self._td_client

    @td_client.setter
    def td_client(self, td_client: TdAmeritradeClient) -> None:
        """Sets the TdAmeritradeClient object for the Portfolio

        Arguments:
        ----
        td_client {TdAmeritradeClient} -- An authenticated session with the TD API.
        """

        self._td_client: TdAmeritradeClient = td_client
